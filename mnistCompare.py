#modification to the mnist loader to create datasets to test comparison with
...
"""Functions for downloading and reading MNIST data then using it for comparisons.
